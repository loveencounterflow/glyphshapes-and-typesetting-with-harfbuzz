(function() {
  'use strict';
  var $, $async, $drain, $show, $watch, CND, DATOM, FS, PATH, SEMVER, SHELL, SP, alert, badge, debug, echo, freeze, help, info, isa, new_datom, rpr, spawn, urge, validate, warn, whisper;
