...
//.........................................................................................................
  ...
  this.$convert_shape_datoms = function(S) {
    var path_end, path_start, symbol_id, use_idx, use_pattern;
    symbol_id = null;
    ...
    use_idx = -1;
    return $(function(d, send) {
      var data, match, ref, ref1, svgpath, value;
      if (d.$key !== '^stdout') {
        return null;
      }
      ...
      if ((value.startsWith(path_start)) && (value.endsWith(path_end))) {
        svgpath = value.slice(path_start.length, value.length - path_end.length);
      ...
      if ((match = value.match(use_pattern)) != null) {
        ...
        if (S.arrangement != null) {
          data.gname = (ref = (ref1 = S.arrangement[use_idx]) != null ? ref1.g : void 0) != null ? ref : null;
        }
  ...
  /* TAINT add styling, font features */
  //-----------------------------------------------------------------------------------------------------------
  this.fetch_outlines = function(settings, arrangement = null) {
    settings = {...defaults.hb_settings, ...settings};
    validate.hb_settings(settings);
    return this._fetch_outlines(settings, arrangement);
  };

  //-----------------------------------------------------------------------------------------------------------
  this._fetch_outlines = function(settings, arrangement = null) {
    return new Promise((resolve, reject) => {
      var S, cp, features, font_path, parameters, pipeline, source, stream_settings, text;
      ({text, font_path, features} = settings);
      //.........................................................................................................
  ...
  if (module === require.main) {
    (async() => {
      var HB, arrangement, features, font_path, settings, text;
      HB = this;
      ...
      return (await HB.fetch_outlines(settings, arrangement));
    })();
  }
